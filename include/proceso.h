...
// Estados de un Proceso para la simulacion.
typedef enum {
...
typedef struct {
    int pid;                // pid = Process ID = identificador unico del proceso
...
void imprimir_resultado_proceso(const PCB *proceso, long espera, long respuestas, long retorno);
